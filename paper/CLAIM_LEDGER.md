...
[Appendix A of stable body 0.8](SYSTEM_SEMANTIC_KERNEL_SSK_WORKING_PAPER_0_8.md#appendix-a-current-claim-state-ledger)
...
Revision 0.8 uses these classes to preserve the 0.7 integrated body and to keep
...
non-restorative continuity, partial perceived context and situated system awareness distinct from
