...
[Appendix A of stable body 0.9](SYSTEM_SEMANTIC_KERNEL_SSK_WORKING_PAPER_0_9.md#appendix-a-current-claim-state-ledger)
...
This index prevents a second ledger from drifting away from the manuscript.
The current claim classes are:

```text
operator_source
conceptual_formalization
represented_architecture
bounded_observation
situated_interpretation
hypothesis
experimental_programme
external_literature_claim
retained_unknown
```

Revision 0.9 uses these classes to preserve the 0.8 integrated body and to keep
...
non-restorative continuity, synthetic situated awareness, source-bound causal regression, variance/dissonance and before/after source propositions distinct from
